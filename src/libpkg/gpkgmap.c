...
/*	from OpenSolaris "gpkgmap.c	1.20	06/02/27 SMI"	*/

/*
 * Portions Copyright (c) 2007 Gunnar Ritter, Freiburg i. Br., Germany
 *
 * Sccsid @(#)gpkgmap.c	1.4 (gritter) 2/25/07
 */
...
static int	getnumvfp(char **cp, int base, long *d, long bad);
