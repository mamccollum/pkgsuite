...
/*	from OpenSolaris "libinst.h	1.52	06/11/17 SMI"	*/

/*
 * Portions Copyright (c) 2007 Gunnar Ritter, Freiburg i. Br., Germany
 *
 * Sccsid @(#)libinst.h	1.3 (gritter) 2/24/07
 */
...
extern int	ocfile __P((VFP_T **mapvfp, VFP_T **tmpvfp, unsigned long map_blks));
...
extern boolean_t	get_proxy_port_admin __P((char **, unsigned short *));
