...
/*	from OpenSolaris "dockspace.c	1.33	06/11/17 SMI"	*/

/*
 * Portions Copyright (c) 2007 Gunnar Ritter, Freiburg i. Br., Germany
 *
 * Sccsid @(#)dockspace.c	1.4 (gritter) 2/25/07
 */
...
#define	TYPE_BLCK	0
#define	TYPE_NODE	1
static void	warn(int type, char *name, ulong_t need, ulong_t avail,
			long limit);
...
static void
warn(int type, char *name, ulong_t need, ulong_t avail, long limit)
{
